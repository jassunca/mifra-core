 ...
 * it receives a SagaStepHistoryMap with all generated saga step results so far and returns its own generated result,
...
public interface ParticipantStepHandler<O extends SagaStepPayload> {
    SagaStepMessage<O> execute(SagaStepHistoryMap historyMap) throws Throwable;
}
